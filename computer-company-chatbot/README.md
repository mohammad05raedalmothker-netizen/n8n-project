...
Download the file computer company chatbot last version.json from this repository.
Open your n8n instance.
Create a new workflow, click on the top-right menu, and select Import from File.
Configure your own OpenAI, Google Sheets, and Gmail credentials.
